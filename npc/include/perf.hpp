...
private:
    ...
    void accumulateStall(
        ...
        m_counters.accumulateStall(
            ifetchWaitResp, memWaitResp, memReqBlocked,
    ...
    void accumulateGprCsr(
        ...
        m_counters.accumulateGprCsr(
            gprReadRs1, gprReadRs2,
    ...
    void accumulateIfetchLsu(
        ...
        m_counters.accumulateIfetchLsu(
            ifetchReq, ifetchLsuReqFire,
