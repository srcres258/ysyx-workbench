...
#endif  // PRINTF_DISABLE_SUPPORT_EXPONENTIAL

// define the default floating point precision
// default: 6 digits
#ifndef PRINTF_DEFAULT_FLOAT_PRECISION
#define PRINTF_DEFAULT_FLOAT_PRECISION  6U
#endif  // PRINTF_DEFAULT_FLOAT_PRECISION

// define the largest float suitable to print with %f
// default: 1e9
#ifndef PRINTF_MAX_FLOAT
#define PRINTF_MAX_FLOAT  1e9
#endif  // PRINTF_MAX_FLOAT

// support for the long long types (%llu or %p)
// default: activated
#ifndef PRINTF_DISABLE_SUPPORT_LONG_LONG
#define PRINTF_SUPPORT_LONG_LONG
#endif  // PRINTF_DISABLE_SUPPORT_LONG_LONG
...
#endif  // PRINTF_DISABLE_SUPPORT_PTRDIFF_T
...
typedef void (*out_fct_type)(
  char character, void *buffer,
  size_t idx, size_t maxlen
);

/**
 * @brief wrapper (used as buffer) for output function type
 */
...
/**
 * @brief internal _putchar wrapper
 */
...
/**
 * @brief internal output function wrapper
 */
...
/**
 * @brief internal secure strlen
 * 
 * @return unsigned The length of the string (excluding the terminating 0)
 * limited by 'maxsize'
 */
static inline unsigned int _strnlen_s(
  const char *str, size_t maxsize
) {
  const char *s;
...
/**
 * @brief output the specified string in reverse, taking care
 * of any zero-padding
 */
static size_t _out_rev(
  out_fct_type out, char *buffer,
  size_t idx, size_t maxlen,
...
/**
 * @brief internal itoa for 'long' type
 */
...
/**
 * @brief internal itoa for 'long long' type
 */
...
// forward declaration so that _ftoa can switch to exp notation
// for values > PRINTF_MAX_FLOAT

/**
 * @brief internal ftoa variant for exponential floating-point type
 */
static size_t _etoa(
  out_fct_type out, char *buffer,
  size_t idx, size_t maxlen,
...
/**
 * @brief internal ftoa for fixed decimal floating point
 */
static size_t _ftoa(
  out_fct_type out, char* buffer,
  size_t idx, size_t maxlen,
...
// implemented with the help from Martin Jasperse <m.jasperse@gmail.com>
static size_t _etoa(
  out_fct_type out, char* buffer,
  size_t idx, size_t maxlen,
  double value, unsigned int prec,
  ...
  const size_t start_idx = idx;
  idx = _ftoa(out, buffer, idx, maxlen, negative ? -value : value,
  ...
  while (*format) {
    ...
    switch (*format) {
      ...
      case 't' :
        ...
        format++;
        break;
#endif  // PRINTF_SUPPORT_PTRDIFF_T
      case 'j' :
